...
class _VideoRecorderState extends State<VideoRecorder> {
  ...
  void _onStopButtonPressed() async {
    ...
    videoPaths = prefs.getStringList("previousPath");
    _stopVideoRecording().then((_) {
      if (mounted) setState(() {
        isRecording = false;
      });

      Navigator.of(context).pushNamed("second_page",arguments: videoPaths);
      Fluttertoast.showToast(
  ...
  Future<String> _startVideoRecording() async {
    ...
    prefs.setStringList("previousPath", videoPaths);
...
class VideoRecorderApp extends StatefulWidget {
  ...
  @override
  _VideoRecorderAppState createState() => new _VideoRecorderAppState();
